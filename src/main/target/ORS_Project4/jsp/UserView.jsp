   ...
   <center>
    ...
    <tr><th style="padding: 3px"></th></tr>          
                ...
                <tr>
                    ...
                    <td><input type="number" style="width:202px" name="mobileNo" maxlength="10" placeholder="Enter Mobile No" size= "25" value="<%=DataUtility.getStringData(bean.getMobileNo())%>"></td>
